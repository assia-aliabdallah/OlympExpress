    ...
    <div class="content">
        <div>
            <h4>
                ...
                <svg id="Logo" class="full-width-svg" xmlns="http://www.w3.org/2000/svg"
                    xmlns:i="http://ns.adobe.com/AdobeIllustrator/10.0/" version="1.1" viewBox="0 0 500 112.56">
                    <g id="express">
                        <g>
            ...
            <p>"Raprochez vous des dieux et obtenez des privilèges qu'aucun autres athéniens n'a pu obtenir pour peut être devenir le héro d'une futur légende !" <br><br>Olympe Express est un site de réservation façonné par les dieux de l'Olympe pour vous permettre, chers Athéniens, d'atteindre vos rêves les plus inaccessibles. Parcourez nos pages et découvrez les services qui changeront le cours de votre vie.</p>
        </div>
        <div>
            <h4>Sources</h4>
            <ul>
                <li>ares-greek-god-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>athena-greek-god-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>demeter-greek-god-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>greek-god-colorful-dionysus-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>greek-goddess-aphrodite-colorful-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>greek-goddess-artemis-colorful-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>greek-gods-colorful-apollo-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>hephaistos-greek-god-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>hera-greek-god-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>hermes-greek-god-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>hestia-greek-god-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>pluto-greek-god-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>poseidon-greek-god-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>zeus-greek-god-by-Vexels.svg - Illustration - <a href="https://www.vexels.com/"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>Bayeu_y_Subias,_Francisco_-_Olympus,_The_Fall_of_the_Giants_-_1764.jpg - Francisco Bayeu y Subías -
                    Domaine Publique - <a
                        href="https://commons.wikimedia.org/wiki/File:Bayeu_y_Subias,_Francisco_-_Olympus,_The_Fall_of_the_Giants_-_1764.jpg"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>D._Creti_Mercurio_e_Paride.jpg - Donato Creti - Domaine Publique - <a
                        href="https://commons.wikimedia.org/wiki/File:D._Creti_Mercurio_e_Paride.jpg"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
                <li>Logo - Olympe Express.svg - Assia ALI ABDALLAH</li>
                <li>Moi.jpg - Assia ALI ABDALLAH</li>
                <li>search.svg - SVG Repo - CC0 License - <a href="https://www.svgrepo.com/svg/7109/search"
                        title="Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Source</a></li>
            </ul>
        </div>
        <div>
            <h4>Conceptrice du site</h4>
            <p>Assia Ali Abdallah étudiante à l’université Gustave Eiffel (Entrepreneuse Individuelle)</p>
            <h4>Hébergement</h4>
            <p> Hébergeur Web o2switch - Chem. des Pardiaux, 63000 Clermont-Ferrand, France (+33 4 44 44 60 40)</p>
        </div>
        <div>
            <h4>Législation relative aux données à caractère personnel</h4>
            <p>Ce site, fait dans le cadre d'un projet étudiant, ne permet pas de faire de vrais achats. En appuyant sur
                le bouton d'envoi du formulaire, vous donnez votre consentement pour transférer vos
                informations vers une base de données. Elles ne seront jamais transmises à des tiers et ne feront
                jamais
                l’objet d’une commercialisation.<br><br>Elles seront conservées dans la base de données du site web,
                accessible uniquement par sa créatrice. Vous détenez les droits d’accès, de rectification,
                d’effacement et à la limitation sur vos données personnelles.<br><br>Pour toute revendication veuillez
                vous
                adresser directement à l'adresse suivante:<a href="mailto:aliabdallah.assia@gmail.com">Assia ALI ABDALLAH</a>.</p>
        </div>
    </div>
    <div class="copyright">
        <span>2024 © OlympExpress. Tous droits réservés.</span>
    </div>
</footer>
<script src="https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/gsap.min.js"></script>
<script src="/scripts/curseur.js"></script>
